...
class CreationCompte
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Depot", mappedBy="creationcompte")
     */
    private $depots;
    ...
    public function removeDepot(Depot $depot): self
    {
        if ($this->depots->contains($depot)) {
            ...
            if ($depot->getCreationcompte() === $this) {
                $depot->setCreationcompte(null);
            }
        }
